...
func (in *HANAMappingSpec) DeepCopyInto(out *HANAMappingSpec) {
	*out = *in
	out.BTPOperatorConfigmap = in.BTPOperatorConfigmap
	out.AdminAPIAccessSecret = in.AdminAPIAccessSecret
